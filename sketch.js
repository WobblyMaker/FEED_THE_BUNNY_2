...
var star1,star2,stars,greyStar,starCount,isCollided1,isCollided2;
var starImg,oneStar,greyStarImg,twoStar,emptyImg;
...
function preload()
{
  ...
  greyStarImg = loadImage('g_star1.png');
...
function setup() 
{
  ...
  star1= createSprite(300,50);
  star1.addImage(starImg);
  star1.scale=0.02;

  star2=createSprite(85,325);
  star2.addImage(starImg);
  star2.scale=0.02;

  stars= createSprite(75,50);
  stars.addImage(oneStar);
  stars.addImage(twoStar);
  stars.addImage(emptyImg);
  stars.scale=0.2;
...
function draw() 
{
  ...
  if(fruit!=null && fruit.position.y>=650)
  {
   ...
   if(collide(fruit,star1,70)==true && isCollided1 == false){
    isCollided1=true;
    star1.visible=false; 
     starCount++; 
   }
   if(collide(fruit,star2,40)==true && isCollided2 == false){
     isCollided2=true;
     star2.visible=false;
     starCount++;
  }
...
function collide(body,sprite,cRadius)
{
  if(body!=null)
        {
